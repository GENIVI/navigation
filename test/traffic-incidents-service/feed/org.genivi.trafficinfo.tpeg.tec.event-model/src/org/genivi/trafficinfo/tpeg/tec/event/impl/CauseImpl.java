 ...
 * <ul>
 *   <li>{@link org.genivi.trafficinfo.tpeg.tec.event.impl.CauseImpl#getMainCause <em>Main Cause</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class CauseImpl extends EObjectImpl implements Cause {
  ...
  /**
	...
	public void setMainCause(CauseCode newMainCause) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EventPackage.CAUSE__MAIN_CAUSE, oldMainCause, mainCause, !oldMainCauseESet));
	}
  ...
  public void unsetMainCause() {
		...
		mainCauseESet = false;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.UNSET, EventPackage.CAUSE__MAIN_CAUSE, oldMainCause, MAIN_CAUSE_EDEFAULT, oldMainCauseESet));
	}
  ...
  /**
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EventPackage.CAUSE__MAIN_CAUSE:
				return getMainCause();
		}
