...
OUTPUT_FILE=NavigationCore_ComponentSpecification.pdf
FILE1=GENIVI_NavigationCore_ComponentSpecification-part1.pdf
FILE2=GENIVI_NavigationCore_ComponentSpecification-part2.pdf
